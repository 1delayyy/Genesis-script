...
menu.action(MenuCredits, "1delay.", {"gscredits"}, "This is My discord, and I did half of Everything, from Scratch.", function(on_click)
    util.toast("- 1delay. -\n\nThis is My discord, and I did half of Everything, from Scratch.")
end)

menu.divider(MenuCredits, "--- GAVE IDEAS ---")

menu.action(MenuCredits, "notcrack", {"gscreditscracky"}, "My Friend, Gave A Few Ideas's To Add To My Script :).", function(on_click)
    util.toast(" - notcrack3 -\n\nMy Friend, Gave A Few Ideas's To Add To My Script :).")
end)

menu.action(MenuCredits, "44_69_6d_61", {"gscredits44_69_6d_61"}, "Another Friend Of Mine, also gave me some Ideas on what to Add to the Script.", function(on_click)
...
menu.action(MenuMisc, "Patch Notes", {"cspatchnotes"}, "New feature's i've added.", function(on_click)
    util.toast("-Genesis-\n\n-Fixed-\n"..PatchNoteFixed.."\n\n-Added-\n"..PatchNoteAdded)
end)
...
function PlayerAddRoot(csPID)
    ...
    MenuPlayerRoot = menu.list(menu.player_root(csPID), "Genesis", {"csplayer"}, "Genesis Options for Selected Player.") ; menu.divider(MenuPlayerRoot, "--- Player Options ---")
    menu.divider(menu.player_root(csPID), "==========^^ Genesis ^^==========")
        
    MenuPlayerFriendly = menu.list(MenuPlayerRoot, "Friendly", {"csplayerfriendly"}, "Genesis Friendly Options for the Selected Player.") ; menu.divider(MenuPlayerFriendly, "--- Player Friendly Options ---") 
    MenuPlayerFun = menu.list(MenuPlayerRoot, "Fun", {"csplayerfun"}, "Genesis Fun Options for the Selected Player.") ; menu.divider(MenuPlayerFun, "--- Player Fun Options ---")    
    MenuPlayerTrolling = menu.list(MenuPlayerRoot, "Trolling", {"csplayertrolling"}, "Genesis Trolling Options for the Selected Player.") ; menu.divider(MenuPlayerTrolling, "--- Player Trolling Options ---")  
    ...
    MenuPlayerKilling = menu.list(MenuPlayerRoot, "Killing", {"csplayerkilling"}, "Genesis Killing Options for the Selected Player.") ; menu.divider(MenuPlayerKilling, "--- Player Killing Options ---")    
    ...
    MenuPlayerRemoval = menu.list(MenuPlayerRoot, "Removal", {"csplayerremoval"}, "Genesis Removal Options for the Selected Player, like Kicks and Crashes.") ; menu.divider(MenuPlayerRemoval, "--- Player Removal Options ---")
